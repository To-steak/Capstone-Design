...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            _cinemachineVirtualCamera = GameObject.FindGameObjectWithTag("CinemachineVirtualCamera").GetComponent<CinemachineVirtualCamera>();
        ...
        private void Interact()
        {
            if (_input.interact)
            {
                ...
                {
                    _interactableObject.GetComponent<ObjectInteraction>().ObjectInteract();
                }
        ...
        private void SwitchCinemachineCamera(int index)
        {
            _cinemachine3RdPersonFollow.Damping = cameraData[index].damping;
            _cinemachine3RdPersonFollow.ShoulderOffset = cameraData[index].shoulderOffset;
            _cinemachine3RdPersonFollow.VerticalArmLength = cameraData[index].verticalArmLength;
            _cinemachine3RdPersonFollow.CameraSide = cameraData[index].cameraSide;
            _cinemachine3RdPersonFollow.CameraDistance = cameraData[index].cameraDistance;
            _cinemachine3RdPersonFollow.CameraCollisionFilter = cameraData[index].cameraCollisionFilter;
            _cinemachine3RdPersonFollow.IgnoreTag = cameraData[index].ignoreTag;
            _cinemachine3RdPersonFollow.CameraRadius = cameraData[index].cameraRadius;
        }
